...
describe('End-to-end tests', function () {
  ...
  it('change log level for requests with matching header', done => {
    exec('./set-log-level.js --header x-abc:xyz warning');
    async.parallel([
      cb => app.get('/').set('x-abc', '123xyz456').expect('A: warning', cb),
